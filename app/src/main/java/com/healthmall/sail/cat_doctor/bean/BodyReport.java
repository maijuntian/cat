...
public class BodyReport implements Serializable {
    ...
    public String getBm_bf_tmRange() {
        if (sex == 0) {
            if (age > 30) {
                return FloatUtils.round(Float.parseFloat(bm_weight) * 48.1f / 100f) + "kg~" + FloatUtils.round(Float.parseFloat(bm_weight) * 51.5f / 100f) + "kg";
            } else {
                return FloatUtils.round(Float.parseFloat(bm_weight) * 49.5f / 100f) + "kg~" + FloatUtils.round(Float.parseFloat(bm_weight) * 52.9f / 100f) + "kg";
            }
        } else {
            if (age > 30) {
                return FloatUtils.round(Float.parseFloat(bm_weight) * 52.3f / 100f) + "kg~" + FloatUtils.round(Float.parseFloat(bm_weight) * 55.6f / 100f) + "kg";

            } else {
                return FloatUtils.round(Float.parseFloat(bm_weight) * 53.6f / 100f) + "kg~" + FloatUtils.round(Float.parseFloat(bm_weight) * 57f / 100f) + "kg";
            }
        }
    }
    ...
    public String getBm_bf_bfRange() {
        if (sex == 0) {
            return FloatUtils.round(Float.parseFloat(bm_weight) * 25 / 100f) + "kg~" + FloatUtils.round(Float.parseFloat(bm_weight) * 28 / 100f) + "kg";
        }
        return bm_bf_bf;
    }
    ...
    public String getBm_bf_smRange() {
        if (sex == 0) {
            return FloatUtils.round(Float.parseFloat(bm_weight) * 25f / 100f) + "kg~" + FloatUtils.round(Float.parseFloat(bm_weight) * 27f / 100f) + "kg";
        } else {
            return FloatUtils.round(Float.parseFloat(bm_weight) * 31f / 100f) + "kg~" + FloatUtils.round(Float.parseFloat(bm_weight) * 34f / 100f) + "kg";
        }
    }
    ...
    public String getBm_bf_bonysaltsRange() {
        if (sex == 0) {
            return "1.8kg-2.5kg";
        } else {
            return "2.5kg-3.2kg";
    ...
    public String getBm_bf_bfrRange() {
        if(sex == 0){
            return "25%~28%";
        } else {
            return "15%~18%";
    ...
    public String getBm_bf_bmrRange() {
        if(sex == 0){
            if(age > 30){
                return "48.1％-51.5％";
            } else {
    ...
    public String getBm_bf_racRange() {
        if(sex == 0){
            return "0.7~0.9";
        } else {
            return "0.8~1.0";
