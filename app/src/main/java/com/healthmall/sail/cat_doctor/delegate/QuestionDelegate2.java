 ...
 */
public class QuestionDelegate2 extends AppDelegate {
    BaseListViewAdapter adapter;

    public List<Question2.Option> options = new ArrayList<>();
    public Question2 currQuestion;
    ...
    public void initQuestion(Question2 question, int size, int index) {
        ...
        pbProgress.setIndex(index + 1);
        tvProgressIndex.setText((index + 1) + "");
        tvStep2.setText(size+"");
        ...
        options.clear();
        options.addAll(question.getOptionList());
        if (adapter == null) {
            adapter = new BaseListViewAdapter<Question2.Option>(options) {
                @Override
                ...
                @Override
                protected void initView(Question2.Option data, BaseViewHolder viewHolder) {
                    viewHolder.setText(R.id.rb_answer, data.getContent())
                            .setChecked(R.id.rb_answer, data.isSelect());
                }
            };
